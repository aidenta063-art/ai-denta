    ...
    >
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/60 bg-white/95 shadow-2xl shadow-black/30 backdrop-blur">
        <div
          ...
          aria-hidden
        />
        <div className="flex flex-col items-center gap-1 px-8 pt-8 pb-2 text-center lg:px-10 lg:pt-10">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-lg font-bold tracking-tight text-[#251037] lg:text-xl">
              Ai denta
            </span>
          </div>
          <h1 className="mt-3 text-2xl font-bold tracking-tight text-[#251037] lg:text-3xl">
            {title}
          </h1>
          {description && (
        ...
        <div className="px-8 pt-4 pb-8 lg:px-10 lg:pb-10">{children}</div>
      </div>
    </motion.div>
  );
}
